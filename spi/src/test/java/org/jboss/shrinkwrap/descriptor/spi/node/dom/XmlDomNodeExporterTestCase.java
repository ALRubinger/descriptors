 ...
 */
public class XmlDomNodeExporterTestCase {
    private static final String XML_HEADER = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>";

    private static final String XML_WITH_COMMENT = "" + XML_HEADER + "<root>" + "  <!-- comment -->"
        + "  <child>test</child>" + "</root>";

    /**
     * Test export counterpoint to SHRINKDESC-31
     */
    @Test
    ...
    private String exportAsString(Node root) {
        ...
        XmlDomNodeExporter.INSTANCE.to(root, output);
